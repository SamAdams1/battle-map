  ...
  return (
    <div className="mt- belowHeader">
      <div className="w-full">
          ...
          {Object.keys(tabs).map((page) => {
            ...
            return (
              <button
                ...
                className={
                  highlight +
                  "  rounded-none rounded-t-lg border-0 p-2 border-b-0"
                }
              >
                {page}
              </button>
        ...
        <div className="py-2 bg-gray-400 flex">
          <button>
            <svg
          ...
          <div className="bg-gray-50 flex flex-1 w-ful">
            <button>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <div className="flex-1 whitespace-nowrap overflow-now inline">
              https://battlemap/admin/{tab}
            </div>
            {/* <div className="right-0 self-end">
              <button>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      <div className="bg-red-00">{tabs[tab]}</div>
    </div>
  );
};
